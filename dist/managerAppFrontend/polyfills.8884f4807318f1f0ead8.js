  ...
  [2],
  {
        ...
        (o =
          ...
          typeof (r = function () {
            ...
            function j(t, r, o) {
              ...
              var i = d(r),
                c = null
              if (a && !(c = a[i]) && ((c = a[i] = a[r]), m(a && e(a, r)))) {
                var s = o(c, i, r)
                ;(a[r] = function () {
            ...
            function q(e, t, r) {
              ...
              function b(t, r) {
                ...
                r && r.prepend && (k = m[d(r.prepend)] = m[r.prepend])
                var C = a
                    ? function (e) {
                        if (!w.isExisting)
                          return S.call(
                    ...
                    return (
                      ...
                      function () {
                        ...
                        if (!i || i(t, d, p, arguments)) {
                          ...
                          var x = a ? F : void 0
                          x && (x.taskData = w)
                          var B = S.scheduleEventTask(P, d, x, o, c)
                          return (
                            (w.target = null),
                            x && (x.taskData = null),
                            k && (_.once = !0),
                            (N || 'boolean' != typeof B.options) &&
                              (B.options = _),
                            (B.target = p),
                            (B.capture = m),
                            (B.eventName = h),
                            v && (B.originalDelegate = d),
                            f ? C.unshift(B) : C.push(B),
                            s ? p : void 0
                          )
                        }
                      }
              ...
              for (var m = [], k = 0; k < t.length; k++) m[k] = b(t[k], r)
              return m
            }
            function U(e, t) {
              if (!t) {
                ...
                if (E) {
                  var a = window,
                    i = (function () {
                      ...
                      : []
                  fe(a, le.concat(['messageerror']), o ? o.concat(i) : o, n(a)),
                    fe(Document.prototype, le, o),
                    void 0 !== a.SVGElement &&
                      fe(a.SVGElement.prototype, le, o),
                    fe(Element.prototype, le, o),
                    fe(HTMLElement.prototype, le, o),
                    fe(HTMLMediaElement.prototype, te, o),
                    fe(HTMLFrameSetElement.prototype, ee.concat(re), o),
                    fe(HTMLBodyElement.prototype, ee.concat(re), o),
                    fe(HTMLFrameElement.prototype, ne, o),
                    fe(HTMLIFrameElement.prototype, ne, o)
                  var c = a.HTMLMarqueeElement
                  c && fe(c.prototype, oe, o)
                  var s = a.Worker
                  s && fe(s.prototype, se, o)
                }
                var l = t.XMLHttpRequest
                l && fe(l.prototype, ae, o)
                var u = t.XMLHttpRequestEventTarget
                u && fe(u && u.prototype, ae, o),
                  'undefined' != typeof IDBIndex &&
                    (fe(IDBIndex.prototype, ie, o),
                    fe(IDBRequest.prototype, ie, o),
                    fe(IDBOpenDBRequest.prototype, ie, o),
                    fe(IDBDatabase.prototype, ie, o),
                    fe(IDBTransaction.prototype, ie, o),
                    fe(IDBCursor.prototype, ie, o)),
                  r && fe(WebSocket.prototype, ce, o)
              }
            }
            function he() {
              ;(Y = Zone.__symbol__),
                (J = Object[Y('defineProperty')] = Object.defineProperty),
                (K = Object[Y('getOwnPropertyDescriptor')] =
                ...
                (Object.defineProperty = function (e, t, n) {
                  ...
                  return 'prototype' !== t && (n = ge(e, t, n)), ye(e, t, n, r)
                }),
                ...
                (Object.getOwnPropertyDescriptor = function (e, t) {
                  var n = K(e, t)
                  return n && ve(e, t) && (n.configurable = !1), n
                })
            }
            function de(e, t, n) {
              var r = n.configurable
              return ye(e, t, (n = ge(e, t, n)), r)
            }
            function ve(e, t) {
              return e && e[Q] && e[Q][t]
            }
            ...
            function _e(e, t) {
              ...
              for (b = 0; b < p.length; b++)
                for (var T = p[b], E = (o[T] = {}), w = 0; w < r.length; w++) {
                  var S
                  ...
                  vh: function (e, t, n, r) {
                    if (!h && v) {
                      if (d)
                        try {
                          var o
                          if ((o = t.toString()) === g || o == y)
                            return e.apply(n, r), !1
                        } catch (a) {
                          return e.apply(n, r), !1
                        }
                      else if ((o = t.toString()) === g || o == y)
                        return e.apply(n, r), !1
                    } else if (d)
                      try {
                        t.toString()
              ...
              ;(o = j(e, (t += r), function (n) {
                return function (o, a) {
                  if ('function' == typeof a[0]) {
                    ...
                    return (
                      'number' == typeof u ? (i[u] = l) : u && (u[me] = l),
                      u &&
                        u.ref &&
                        u.unref &&
            ...
            Zone.__load_patch('legacy', function (e) {
              ...
              Zone.__load_patch('requestAnimationFrame', function (e) {
                ke(e, 'request', 'cancel', 'AnimationFrame'),
                  ke(e, 'mozRequest', 'mozCancel', 'AnimationFrame'),
                  ke(e, 'webkitRequest', 'webkitCancel', 'AnimationFrame')
              }),
    ...
    'N/DB': function (e, t) {
      ...
      ;(n || a || r || o).$localize = function e(t) {
        ...
        for (var c = i(t[0], t.raw[0]), s = 1; s < t.length; s++)
          c += r[s - 1] + i(t[s], t.raw[s])
        return c
      }
    },
    'hN/g': function (e, t, n) {
      'use strict'
      n.r(t), n('0TWp'), n('N/DB'), (window.global = window)
    },
  },
  [[2, 0]],
])
//# sourceMappingURL=polyfills.8884f4807318f1f0ead8.js.map
